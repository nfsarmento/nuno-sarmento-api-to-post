...
[youtube https://www.youtube.com/watch?v=uPb3i4r2J5Q]
...
1. Upload the plugin files to the `/wp-content/plugins/Nuno-Sarmento-api-to-post` directory, or install the plugin through the WordPress plugins screen directly.
